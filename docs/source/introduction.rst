...
The **sislib** is python library for reading or working with the data
...
The microframework is meant to be used by developers to help them build 
...
We recommend the framework for small background software applications that 
...
of creating a framework for small, similar, and flexible, yet 
